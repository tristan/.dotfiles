...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "l", function() awful.util.spawn("sync") awful.util.spawn("xautolock -locknow") end, {description = "lock the screen"}),
...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey, "Control" }, "s", function ()
         awful.util.spawn_with_shell("~/.config/awesome/screenshot.sh")
   end)
)
